...
data NP   = NP0 Pronoun | NP1 Proper | NP2 DET CN | NP3 DET RCN deriving Show
...
data SCN = Someone | Belief | Man | Woman | Hero | Heroine | Sword | 
           ...
           Spy | S CCN deriving Show

data CCN =  Coven | Court | Horde | Cabal | Commitee | 
            Pair | Army | Pack | Hive | Nest | Crowd | Group deriving Show
...
data DistPronoun = Each | Every | Neither | Either | Any | None | Many | Few deriving Show
...
data DET  = Each | Every | Neither | Either | Many | Few | The | Every |
...
type Name    = String
data Proper  = Prop Name deriving Show

data VP = VP0 INF | VP1 TV NP  | VP3 AV To INF | VP4 AuxV INF
          VP5 AuxV TV | VP6 AuxV DV | VP7 AuxV AV deriving Show
