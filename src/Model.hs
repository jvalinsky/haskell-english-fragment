...
data Atom = Sword1      | Sword2   | Alice'   | Bob'    | Cyrus'     | Ellie'       | 
            ...
            Gerald'     | Minnie'  | Mickey'  | Sue'    | The_Rhine' | Dis' | Thorin' deriving (Eq, Show, Bounded, Enum)
...
thingList = [Sword1, Sword2, Dagger1, Cup1, Cup2, Bottle1, Bottle2, The_Genesee', 
              Dress1, Dress2, Raft1, Raft2, Raft3, Raft4, Glasses1, Jeans1]
...
oldList :: [Atom]
oldList = [Sword1, Bottle1, Jeans1] ++ (personList \\ youngList) ++ birdList
...
metalList :: [Atom]
metalList = [Sword1, Sword2, Dagger1]
